...
import static ta.ligado.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import ta.ligado.config.Constants;
import ta.ligado.domain.User;
import ta.ligado.repository.AuthorityRepository;
import ta.ligado.repository.UserRepository;
import ta.ligado.security.AuthoritiesConstants;
import ta.ligado.service.UserService;
import ta.ligado.service.dto.AdminUserDTO;
import ta.ligado.service.dto.PasswordChangeDTO;
import ta.ligado.service.dto.UserDTO;
import ta.ligado.web.rest.vm.KeyAndPasswordVM;
import ta.ligado.web.rest.vm.ManagedUserVM;
